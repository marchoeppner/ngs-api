...
pipelines = {
    ...
    "foodme2_1.2.0_meat" => { "name" => "foodme2_1.2.0_meat", "description" => "FooDMe2 - Metabarcoding für ASU 184", "version" => "1.2.0", "template" => "/work_syn/shared/software/nextflow/nextflow run bio-raum/FooDMe2 --primer_set amnioted_dobrovolny", "samplesheet_format" => "sample\tfq1\tfq2" },
