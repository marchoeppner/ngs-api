...
pipelines = {
    ...
    "read-qc" =>{ "name" => "readqc_0.1", "runlevel" => true, "description" => "Read-QC - quality control of sequencing runs", "version" => "dev", "template" => "/work_syn/shared/software/nextflow/nextflow run marchoeppner/read-qc" }
}
